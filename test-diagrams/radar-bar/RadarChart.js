...
function RadarChart(id, data, options) {
    ...
    blobWrapper
        ...
        //MY EDIT TO DISPLAY THE NAME OF THE TEAM
        .append("title").text(function (single_radar_item,item_id) {
            //console.log(single_radar_item);
            return "This is the radar : "+item_id+" and one value is : "+single_radar_item[0].axis;
    ...
    var legend_color = cfg.color;


//D3 Vertical Legend//////////////////////////
    var legend3 = g.selectAll('.legend3')
    ...
    legend3.append("text")
        .attr("x",2)
        .append("textPath")
        .attr("xlink:href", function(d, i) { return "#legend" + i; })
        .style("text-anchor","start") //place the text halfway on the arc
        .attr("font-family","Comic Sans MS")
        .text(function(d, i) { return "Team: "+ d; })
    ;
